...
**Current module: 21 complete — next is Module 22 (Frontend: Create Page — Publish)**
...
4. **Commit**: stage all new and modified files for this module and commit with message `Module X: <short description>`. Do not add `Co-Authored-By` lines to commit messages. Then tell the user to push — do not run `git push` yourself.
